...
<main class="d-flex flex-nowrap">
  ...
  <div class="form-signin m-auto ">
		...
		<form id="formula" action="eliminar2.php" method="post">
			<select id="selec" name="TituloOriginal">
			<?php
				include 'conexion2.php';
				$consulta = $conexion2 -> query ("SELECT Lib_Titulo FROM  tb_libro ORDER BY Lib_Titulo ASC") 
      ...
      <br>
      <br>
			<input class="w-50 btn " style="background-color: rgb(195, 108, 108);" type="submit" value="Borrar!!" />
                </form>
				</div>
